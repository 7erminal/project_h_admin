...
const ServicesOverviewSlabs: React.FC = () => {
    ...
    const allServices = ():void => {
        new Api().getAllServices()
                .then(response => {
                        console.log("Get the real services")
...
if(document.getElementById('number-of-services-hosted')){
    createRoot(document.getElementById('number-of-services-hosted')!).render(<ServicesOverviewSlabs />)
}